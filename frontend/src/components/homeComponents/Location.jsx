...
//                 <label for="location" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" id="el-dfgn8agb">State</label>
...
//                     </svg>
//                   </div>
//                   <input type="text" id="state" name="location" placeholder="Enter state" class="block w-full pl-10 pr-3 py-3 border  border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500 dark:focus:ring-green-400 focus:border-green-500 dark:focus:border-green-400"/>
//                 </div>

//                 <label for="location" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 mt-2" id="el-dfgn8agb">District/City</label>
//                 <div class="relative" id="el-d2vlwpub">
//                   <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none" id="el-pnkmcpui">
//                     <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" id="el-nsiau1bv">
//                       <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" id="el-4digfvlq"></path>
...
//                     </svg>
//                   </div>
//                   <input type="text" id="district-city" name="location" placeholder="Enter district/city" class="block w-full pl-10 pr-3 py-3 border  border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500 dark:focus:ring-green-400 focus:border-green-500 dark:focus:border-green-400"/>
//                 </div>
